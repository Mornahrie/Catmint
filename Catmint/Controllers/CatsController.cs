...
namespace Catmint.Controllers
{
    public class CatsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("cat_id,sex_id,place_id,cat_name,cat_age,history,cat_photo,status")] Cat cat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("cat_id,sex_id,place_id,cat_name,cat_age,history,cat_photo,status")] Cat cat)
        {
            if (id != cat.cat_id)
            {
                return NotFound();
        ...
        {
          return (_context.Cats?.Any(e => e.cat_id == id)).GetValueOrDefault();
        }
    }
}
